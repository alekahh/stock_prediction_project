...
# 1. LOAD RAW DATASETS
# =====================
# Dynamic base path that works on any machine
...
macro = pd.read_csv(processed_data_dir / "macro_data_cleaned.csv", parse_dates=['date'])
...
plt.tight_layout()
plt.savefig(plots_dir / "improved_transformer_results.png", dpi=300, bbox_inches='tight')
